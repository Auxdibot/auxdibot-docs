<div align="center" id="header">
   ...
   <h1>Auxdibot Documentation</h1>
</div>


## About Project

This is the repository housing the official Docusaurus documentation page for Auxdibot.

### Important Files

`/docs` - **Documentation files for Auxdibot**

`/src` - **Components and styles for Auxdibot documentation**

`/sidebars.ts` - **Contains the configuration for the sidebar used on the website.**

`/docusaurus.config.ts` - **Contains the configuration files for Docusaurus.**
